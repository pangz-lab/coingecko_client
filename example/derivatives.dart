...
void main() async {
  try {
    ...
    var list = await client.derivatives
        .getList(includeTickers: DerivativesTickers.unexpired);
    ...
    var exchange = await client.derivatives
        .getExchange(id: "bybit", includeTickers: DerivativesTickers.unexpired);
    print(exchange);
    print(exchange.id);
    print(exchange.name);
    ...
    var exchangeBasicInfoList =
        await client.derivatives.getExchangeBasicInfoList();
