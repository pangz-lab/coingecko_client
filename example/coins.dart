...
void main() async {
  ...
  try {
    ...
    var coinHistory = await client.coins.getHistory(id: 'verus-coin', date: DateTime.now());
    print(coinHistory);
    print(coinHistory.name);

    /// sample call for - /coins/markets
    var coinMarket = await client.coins.getMarketList(vsCurrency: Currencies.php);
    ...
    var coinMarketHistoryWithDateRange = await client.coins.getMarketHistoryWithDateRange(
      id: 'verus-coin',
      vsCurrency: Currencies.php,
