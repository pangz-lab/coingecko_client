...
void main() {
  ...
  group('getBasicList method in', () {
    ...
    group('NftsEndpoint test endpoint response', () {
      test('with data in getting the correct response type', () async {
        ...
        expect(firstItem.contractAddress, "0x36F379400DE6c6BCDF4408B282F8b685c56adc60");
        ...
        expect(lastItem.contractAddress, "0xd4e4078ca3495de5b1d4db434bebc5a986197782");
  ...
  group('getInfo method in', () {
    ...
    group('NftsEndpoint test endpoint path creation', () {
      var sut = NftsEndpoint(
        HttpRequestServiceMock(
          statusCode : 200,
          body: NftInfoMockData.validResponseBody
        )
      );
    ...
    group('NftsEndpoint test endpoint response', () {
      test('with data in getting the correct response type', () async {
        ...
        expect(result.contractAddress, "0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7");
        ...
        expect(result.image!.small, "https://assets.coingecko.com/nft_contracts/images/28/small/meebits.png?1644852788");
        expect(result.image!.thumb, null);
        expect(result.image!.large, null);
        expect(result.description, "The Meebits are 20,000 unique 3D voxel characters, created by a custom generative algorithm, then registered on the Ethereum blockchain.");
  ...
  group('getContractInfo method in', () {
    var basePath = "/nfts/ethereum/contract/0x36F379400DE6c6BCDF4408B282F8b685c56adc60";
    group('NftsEndpoint test endpoint path creation', () {
      var sut = NftsEndpoint(
        HttpRequestServiceMock(
          statusCode : 200,
    ...
    group('NftsEndpoint test for error handling', () {
      test('should throw an exception for failed request', () async {
        ...
        await expectLater(sut!.getContractInfo(
          assetPlatformId: 'ethereum',
          contractAddress: '0x36F379400DE6c6BCDF4408B282F8b685c56adc60'
        ), throwsA(isA<NetworkRequestException>()));
      });
