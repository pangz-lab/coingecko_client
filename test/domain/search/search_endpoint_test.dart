...
void main() {
  ...
  group('getResult method in', () {
    ...
    group('SearchEndpoint test endpoint path creation', () {
      var sut = SearchEndpoint(
        HttpRequestServiceMock(
          statusCode : 200,
          body: SearchMockData.validResponseBody
        )
      );
    ...
    group('SearchEndpoint test for error handling', () {
      test('should throw an exception for failed request', () async {
        ...
        await expectLater(sut!.getResult(
          query: 'bybit'
    ...
    "error": "coin not found"
        ...
        await expectLater(sut!.getResult(query: 'bybit'), throwsA(isA<DataParsingException>()));
