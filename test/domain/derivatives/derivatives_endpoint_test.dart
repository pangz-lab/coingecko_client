...
void main() {
  ...
  group('getList method in', () {
    ...
    group('DerivativesEndpoint test endpoint response', () {
      test('with data in getting the correct response type', () async {
        ...
        expect(firstItem.lastTradedAt!.toUtc(),
            DateTime.parse("2023-05-04 04:44:06.000Z"));
    ...
    group('DerivativesEndpoint test for error handling', () {
      test('should throw an exception for failed request', () async {
        sut = DerivativesEndpoint(HttpRequestServiceMock(
            statusCode: 500, body: DerivativesMockData.validResponseBody));
        await expectLater(
            sut!.getList(includeTickers: DerivativesTickers.unexpired),
  ...
  group('getExchangeList method in', () {
    ...
    group('DerivativesEndpoint test endpoint path creation', () {
      ...
      test('with all parameters', () async {
        ...
        expect(sut.endpointPath,
            "$apiVersionPath$basePath?order=name_asc&per_page=10&page=2");
      });
    });
    ...
    group('DerivativesEndpoint test endpoint response', () {
      test('with data in getting the correct response type', () async {
        ...
        expect(firstItem.image,
            "https://assets.coingecko.com/markets/images/403/small/gate_io_logo.jpg?1654182143");
        ...
        expect(secondtItem.image,
            "https://assets.coingecko.com/markets/images/917/small/ezgif.com-gif-maker.jpg?1658483171");
    ...
    "error": "coin not found"
        ...
        sut = DerivativesEndpoint(HttpRequestServiceMock(
            statusCode: 200,
            body:
                DerivativesExchangeListMockData.responseBodyWithInvalidFormat));
        await expectLater(
            sut!.getExchangeList(
                order: DerivativesExchangeOrdering.nameAsc,
                perPage: 10,
  ...
  group('getExchange method in', () {
    ...
    group('DerivativesEndpoint test endpoint path creation', () {
      ...
      test('with required parameters', () async {
        await sut.getExchange(id: "bybit");
        expect(sut.endpointPath, "$apiVersionPath$basePath");
      });
    ...
    group('DerivativesEndpoint test endpoint response', () {
      test('with data in getting the correct response type', () async {
        ...
        expect(result.image,
            "https://assets.coingecko.com/markets/images/460/small/photo_2021-08-12_18-27-50.jpg?1628764200");
        ...
        expect(tickerFirstItem.tradeUrl,
            "https://www.bybit.com/app/exchange/10000NFTUSDT");
        ...
        expect(tickerFirstItem.convertedVolume!['btc'],
            "2.381598411684822141052551");
        expect(tickerFirstItem.convertedVolume!['usd'],
            "69236.9969033612388211814");
        expect(tickerFirstItem.convertedLast!.length, 3);
        expect(tickerFirstItem.convertedLast!['btc'],
            "0.00000012788450119020366854678263");
        expect(tickerFirstItem.convertedLast!['usd'],
            "0.003717813536258691189050514548519798361857");
