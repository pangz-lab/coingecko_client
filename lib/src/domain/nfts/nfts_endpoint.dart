...
import 'package:coingecko_client/src/domain/nfts/enums/nfts_data_ordering.dart';
...
class NftsEndpoint extends BaseEndpoint {
  NftsEndpoint(HttpRequestServiceInterface httpRequestService, {String? apiKey})
